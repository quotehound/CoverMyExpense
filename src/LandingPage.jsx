    ...
    <div className="flex flex-wrap justify-between items-center -mx-4">
      ...
      <div className="w-full lg:w-4/6 px-4">
        <div className="flex flex-wrap items-center justify-end">
          ...
          <a className="inline-block mr-auto lg:mr-0 py-4 px-8 text-sm text-white font-medium leafing-normal bg-blue-500 hover:bg-blue-300 hover:shadow-lg rounded" onClick={this.autoFocusClick} data-config-id="primary-action">Get Your No Quote Quote</a>
        </div>
